...
/// ~0.5s @ 16 kHz — short questions still fire; noise gate drops coughs.
pub const MIN_UTTERANCE_SAMPLES: usize = 8_000;
/// Wait after the last fragment before sending.
pub const MERGE_GAP: Duration = Duration::from_millis(200);
/// Hard cap ~10s
